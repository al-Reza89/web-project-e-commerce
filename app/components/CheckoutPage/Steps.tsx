...
const Steps: React.FC<StepsProps> = ({ currentStep, stepLength }) => {
  return (
    <div>
      <div className="px-20 mx-auto pt-2">
        <h2 className="sr-only">Steps</h2>
        <div>
          <ol className="grid grid-cols-1 divide-x divide-gray-100   text-black overflow-hidden rounded-lg border border-gray-100 text-sm  sm:grid-cols-3">
            <li
